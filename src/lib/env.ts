...
const envSchema = z.object({
  ...
  // Bedrock
  BEDROCK_MODEL_SONNET: z.string().default('us.anthropic.claude-sonnet-4-6-20250915-v1:0'),
  BEDROCK_MODEL_HAIKU: z.string().default('us.anthropic.claude-haiku-4-5-20251001-v1:0'),
